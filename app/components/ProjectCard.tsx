...
export default function ProjectCard({
  ...
  return (
    <div className="relative w-full max-w-[528px] h-[732px] rounded-[2rem] flex items-center justify-center ">
      ...
      <div className="w-full max-w-[400px] h-[600px] z-10 rounded-[2rem] border-[1px] bg-white border-[#2b69fb0f] p-4 flex flex-col">
        <div className="w-full h-[200px] rounded-[1rem] overflow-hidden">
          <img
            src={imageUrl}
            alt={title}
            onClick={onCLick}
            className="w-full h-full object-cover hover:scale-125 cursor-pointer transition-transform duration-500 "
          />
        </div>
